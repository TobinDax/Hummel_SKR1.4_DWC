...
M550 P"Hummel"                                 ; set printer name
...
M558 P9 C"^probe" H5 F600 T7200                ; set Z probe type to bltouch and the dive height + speeds
G31 P500 X26.3 Y8 Z2.5                         ; set Z probe trigger value, offset and trigger height
M557 X5:199 Y5:217 S20                         ; define mesh grid
...
M106 P1 S0 H0 T45                              ; set fan 1 value. Thermostatic control is turned on
